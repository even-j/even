layui.use(['form', 'layer', 'table', 'laytpl', 'laydate'], function () {
    ...
    var tplImg = function (d) {
        return '<img class="jump" src="'+d.idcard_img_a+'" style="height: 170px; width: 200px;" >';
    };
    //身份证反面照
    ...
    var bank = function (d) {
        ...
        <div class="text-warning">银行卡号:<span>`+d.bank_no+`</span></div>
        <div class="text-info">姓名:<span>`+d.bank_user+`</span></div>`;
    };
    ...
    var tableIns = table.render({
        elem: '#userList',
        url: '/index.php/admin/finance/UserBankCardAudit',
        toolbar: '#toolbarDemo',
        method:'post', //默认是get
        cellMinWidth: 60,
        page: true,
        ...
        cols: [[
            ...
            // { field: 'bank_no', title: '银行卡号', minWidth: 250, align: "center" },
    ...
    table.on('tool(userList)', function (obj) {
        ...
        if (layEvent === 'del') { //删除
            layer.confirm('确定删除？', { icon: 3, title: '提示信息' }, function (index) {
                ...
                obj.del();
                layer.close(index);
                $.post("/index.php/admin/finance/bank_del",{id:obj.data.id,type:2},function (res) {
    ...
    function examine(edit) {
        layui.layer.open({
            type: 2,
            content:"/index.php/admin/finance/examine/id/"+edit.id+'/type/'+2,
            area: ['900px', '300px'],
            title: '违规备注',
