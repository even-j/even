layui.use(['form', 'layer', 'table', 'laytpl', 'laydate'], function () {
    ...
    var num1 = function (d) {
        if(d.price<0){
            return `<div class="text-danger">`+d.price+`元</div>`
        }else{
            return `<div class="text-success">`+d.price+`元</div>`
        }
    ...
    var tableIns = table.render({
        elem: '#userList',
        url: '/index.php/admin/finance/SellerDepositBalanceRecord',
        toolbar: '#toolbarDemo',
        method:'post', //默认是get
        page: true,
        limits: [10, 15, 20, 25],
        ...
        cols: [[
            ...
            { field: '1', title: '操作金额', minWidth: 190, align: "center", templet:num1 },
