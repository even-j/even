layui.use(['form', 'layer', 'table', 'laytpl', 'laydate', 'upload'], function () {
	...
	var tableIns = table.render({
		elem: '#userList',
		url: '/index.php/admin/system/adUser',
		toolbar: '#toolbarDemo',
		method:'post',
		cellMinWidth: 95,
		page: true,
		...
		cols: [[
			...
			{ field: 'role_id', title: '角色名', width: 200, align: "center" },
			{ field: 'logins_num', title: '登录次数', width: 200, align: "center" },
			{ field: 'logins_time', title: '上次登录时间', width: 200, align: "center" },
			{ field: 'logins_ip', title: 'IP', width: 200, align: "center" },
	...
	function edit(edit={id:0}) {
		layui.layer.open({
			type: 2,
			content: "/index.php/admin/system/addUser/id/"+edit.id,
			area: ['800px', '450px'],
			title: '新增后台用户',
	...
	function deletebp(edit, obj) {
		layer.confirm('真的删除行么？', function (index) {
			obj.del();
			layer.close(index);
			$.post("/index.php/admin/system/delete_user",{id:edit.id},function (res) {
