...
class Index extends Base
{
    ...
    public function bankAdd(Request $request){
        ...
        try{
            ...
            $img = Img::base64_image_content($data['idcard_img'],"./uploads/info/");
            if($img['code']==0)throw new Exception('身份证'.$img['data']);
            $add['idcard_img'] = $img['data'];
