<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpstudy\WWW\zhan\shua_li\pubic/../application/admin\view\system\system.html";i:1698734827;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group col-6">
                    <label>收款银行名称：</label>
                    <div class="input-group spinner">
                        <input type="text" class="form-control text-center" value="<?php echo $data['bank_name']; ?>" placeholder="请输入内容" lay-verify="input10"
                               name="alipay">
                    </div>
                </div>
                <div class="form-group col-6">
                    <label>支行名称：</label>
                    <div class="input-group spinner">
                        <input type="text" class="form-control text-center" value="<?php echo $data['bank_zhihang']; ?>" placeholder="请输入内容" lay-verify="input10"
                               name="alipay">
                    </div>
                </div>
                <div class="form-group col-6">
                    <label>银行卡号：</label>
                    <div class="input-group spinner">
                        <input type="text" class="form-control text-center" value="<?php echo $data['bank_num']; ?>" placeholder="请输入内容" lay-verify="input10"
                               name="alipay">
                    </div>
                </div>
                <div class="form-group col-6">
                    <label>银行卡姓名：</label>
                    <div class="input-group spinner">
                        <input type="text" class="form-control text-center" value="<?php echo $data['bank_user']; ?>" placeholder="请输入内容" lay-verify="input10"
                               name="alipay">
                    </div>
                </div>
                ...
                <div class="form-group col-6">
                    <label>QQ群号：</label>
                    <div class="input-group spinner">
                        <input type="text" class="form-control text-center" value="<?php echo $data['qq']; ?>" placeholder="请输入内容" lay-verify="input10"
                               name="alipay">
                    </div>
                </div>
                ...
                <div class="form-group col-6">
                    ...
                    <div class="input-group spinner">
                        <input type="text" class="form-control text-center" value="<?php echo $data['alipay_url']; ?>" placeholder="请输入内容" lay-verify="input10"
                               name="alipay">
                    </div>
                </div>
                ...
                <div class="form-group col-6">
                    <label>客服微信二维码：</label>
                    <div class="input-group spinner">
                        <input type="text" class="form-control text-center" value="<?php echo $data['wechat_url']; ?>" placeholder="请输入内容" lay-verify="input10"
                               name="alipay">
                    </div>
                </div>
