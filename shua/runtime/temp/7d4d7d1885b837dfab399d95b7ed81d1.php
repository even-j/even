<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpstudy\WWW\zhan\shua_li\pubic/../application/admin\view\system\ad_user.html";i:1565000298;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="childrenBody">
	...
	<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container table-tool">
                <button class="layui-btn layui-btn-normal addBasicParameter"  lay-event="detail">新增后台用户<i class="layui-icon">&#xe605;</i></button>
			</div>
		</script>
	<!--审核状态-->
	...
	<script type="text/javascript" src="/admin_style/adUser.js"></script>
