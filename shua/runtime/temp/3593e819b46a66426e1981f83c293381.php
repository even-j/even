<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/wwwroot/xbt.com/pubic/../application/admin/view/seller/yajin.html";i:1571475862;}*/ ?>
<!DOCTYPE html>
<html>
...
<form class="layui-form">
    <blockquote class="layui-elem-quote quoteBox">
        <form class="layui-form">
            ...
            <!--                </div>-->
            <div class="layui-inline">
                <label class="layui-form-label">本金财务日期：</label>
                <div class="layui-input-inline">
...
<script>
    layui.use(['form', 'layer', 'table', 'laytpl', 'laydate'], function () {
        ...
        var tableIns = table.render({
            elem: '#userList',
            url: '/index.php/admin/seller/yajin/id/'+dataid+'',
            method:'POST',
            toolbar: '#toolbarDemo',
           // cellMinWidth: 95,
            page: true,
            ...
            cols: [[
                ...
                { field: 'price', title: '金额', minWidth: 50, width: 100, align: "center" },
        ...
        form.on("submit(reload)", function (data) {
            ...
            var describe = field.describe;  //描述
