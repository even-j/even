<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpstudy\WWW\zhan\shua_li\pubic/../application/admin\view\notice\buyer_bulletin.html";i:1567046098;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <script>
        layui.use(['form','table'], function () {
            ...
            var tableIns = table.render({
                elem: '#test'
                , url: "<?php echo url('notice/BuyerBulletin'); ?>"
                , method:'post'  //默认是get
                , toolbar: '#toolbarDemoo'
                , title: '新增买家公告'
                , cols: [[
                { field: 'id', title: 'id', width: 440, align:"center" }
                    , { field: 'title', title: '标题', width: 440, align:"center" }
                    , { field: 'create_time', title: '加入时间', width: 320, align:"center" }
                    , {
                        field: 'newsTop',
                        title: '是否置顶',
                        align: 'center',
                ...
                ,page: {  //支持传入 laypage 组件的所有参数（某些参数除外，如：jump/elem） - 详见文档
                    ...
                    ,last: false
                    //不显示尾页
                    ,limits: [10, 15, 30, 60, 100,500,1000]
                    //每页条数
            ...
            function addNews(edit){
                var index = layui.layer.open({
                    ...
                    type : 2,
                    area: ['700px', '950px'],
                    content : "<?php echo url('notice/newsAdd',['type'=>1]); ?>",
            ...
            form.on('switch(switchTest)', function(data){
                ...
                $.post("<?php echo url('notice/top_notice'); ?>",{id:data.value},function (res) {
