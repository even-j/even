<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/xbt.com/pubic/../application/admin/view/notice/business_bulletin.html";i:1569048404;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <script type="text/javascript">
        layui.use(['form','table'], function () {
            ...
            var tableIns = table.render({
                elem: '#test'
                , url: "<?php echo url('notice/BusinessBulletin'); ?>"
                , method:'post'//默认是get
            ...
            function addNews(edit){
                var index = layui.layer.open({
                    ...
                    type : 2,
                    area: ['700px', '950px'],
                    content : "<?php echo url('notice/newsAdd',['type'=>3]); ?>",
