<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/xbt.com/pubic/../application/admin/view/seller/addbuyer.html";i:1571277544;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
    ...
    layui.use(['form', 'layer', 'table', 'laytpl', 'laydate'], function () {
        ...
        form.on("submit(reload)", function (data) {
            ...
            $.ajax({
                type : 'POST',
                url : "/index.php/admin/seller/addbuyer",
                async : true,
                data : {
                    'name':name,
                    'login_pwd':password,
