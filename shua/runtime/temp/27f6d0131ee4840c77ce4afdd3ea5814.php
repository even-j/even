<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/xbt.com/pubic/../application/admin/view/buyer/buyer_list.html";i:1578374428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="tel" name="tjuser" lay-verify="tjuser" autocomplete="off"
							   class="layui-input account" placeholder="请输入来源id">
					</div>
...
<!--					</div>-->
		...
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container table-tool">
			  <button class="layui-btn layui-btn-normal delAll_btn">新增买家 <i class="layui-icon">&#xe605;</i></button>
			</div>
		</script>
		<!--审核状态-->
		...
		<script type="text/html" id="userListBar">
			...
			<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="maihao">买 号</a>
...
<!--			<a class="layui-btn layui-btn-xs" lay-event="tixian">提现账户</a>-->
			<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="xiaoxi">消息</a>
		</script>
	</form>
	<script type="text/javascript" src="/admin_style/layui/layui.js"></script>
	<script type="text/javascript" src="/admin_style/BuyerList.js"></script>
