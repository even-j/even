<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpstudy\WWW\zhan\shua_li\pubic/../application/seller\view\login\register.html";i:1698725242;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
         ...
         el: ".container",
          ...
          methods: {
            ...
            click:function(){
              ...
              $.ajax({
                type : 'POST',
                url : "<?php echo url('seller/login/check_register'); ?>",
                async : true,
                data : {
                  "mobile":vm.mobile,
                  "login_pwd":vm.login_pwd,
                  "login_pwd2":vm.login_pwd2,
                  "qq":vm.qq,"wechat":vm.wechat,
    ...
    <div class="container">
      ...
      <div class="login_box">
        ...
        <div class="login_input">
          ...
          <div class="input_box">
            <img class="input_pic" src="/static/buy/img/user.png" />
            <input type="text" name="province" id="province" placeholder="province" class="user_input" v-model="province">
          </div>

          <div class="input_box">
            <img class="input_pic" src="/static/buy/img/user.png" />
            <input type="text" name="city" id="city" placeholder="city" class="user_input" v-model="city">
          </div>
