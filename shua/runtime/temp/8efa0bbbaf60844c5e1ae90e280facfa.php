<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpstudy\WWW\zhan\shua_li\pubic/../application/seller\view\goods\edit.html";i:1593441410;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script>
    var name = new Vue({
        ...
        methods: {
            ...
            getData:function(){
                var that = this;
                $.post("<?php echo url('goods/edit'); ?>",{id:"<?php echo $id; ?>"},function(res){
                    if(res.code==1){
            ...
            storage(){
                ...
                $.post("<?php echo url('goods/goodsEditDo'); ?>",this.goods,function(res){
                    if(res.code==1){
