<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\phpstudy\WWW\zhan\shua_li\pubic/../application/seller\view\recharge\cash.html";i:1571452326;s:71:"D:\phpstudy\WWW\zhan\shua_li\application\seller\view\public\header.html";i:1698557939;s:71:"D:\phpstudy\WWW\zhan\shua_li\application\seller\view\public\footer.html";i:1698558175;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="right">
	<!-- 基本信息标题 --> 
	<div class="right-top">
		<b>个人中心 / 资金管理 /<strong> 押金提现 </strong></b>
	</div>
		...
		<div class="web_gonggao">
			<div class="gonggao_row">
				<div class="gonggao_top">
					<a href="javascript:" class="select_on">押金提现</a>
				</div>
			</div>
		</div>
		<!-- 押金提现部分 -->
			...
			<div class="dakuan">
				...
				<div class="dakuan_col">
					<div class="dakuan_box1">
						<span>银行卡转账</span>
						<a href="<?php echo url('index/bank'); ?>" target="_blank" class="dakuan_view">查看提现账户</a>
					</div>
		...
		var vm = new Vue({
			...
			data: function () {
				return {
					radio: "1",
					/* 输入框数量默认值5 */
					tiXianNum: "<?php echo $config['seller_min_money']; ?>",
					/* 到账金额 */
					daoZhangPrice: "<?php echo $config['seller_min_money']-$config['seller_min_money']*$config['seller_cash_fee']; ?>",
					/* 提现最低金额 */
					tiXianPrice: Number("<?php echo $config['seller_min_money']; ?>"),
					/*提现手续费*/
					fee: "<?php echo $config['seller_cash_fee']; ?>",
					pay_pwd:'',
				}
			},
			methods: {
				...
				tiXianBtnActive: function () {
					...
					this.$confirm("您确定要提现吗?", "温馨提示", {
						...
						$.post("<?php echo url('recharge/cashDo'); ?>",{price:that.tiXianNum,pay_pwd:that.pay_pwd},function(res){
							if(res.code==1){
